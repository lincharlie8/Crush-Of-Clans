				...
				case TouchPhase.Stationary:
					...
					if(Mathf.Pow (temp_x - start_pixel_x, 2) + Mathf.Pow(temp_y - start_pixel_y, 2) > Mathf.Pow (r / 2, 2)){
						...
						if(Player_script.move_flag){
							if(Player_script.Trigger_ob.name == "Right" || Player_script.Trigger_ob.name == "Left"){
								start = Mathf.Pow(Mathf.Pow (Player_script.player_temp.x - Player_script.point[0], 2) , 0.5f);
								end = Mathf.Pow(Mathf.Pow ((Player_script.player_temp.x - Player_script.move_speed * Mathf.Sin (temp)) - Player_script.point[0], 2) , 0.5f);
							}else if(Player_script.Trigger_ob.name == "Top" || Player_script.Trigger_ob.name == "Bottom"){
								start = Mathf.Pow(Mathf.Pow (Player_script.player_temp.z - Player_script.point[1], 2) , 0.5f);
								end = Mathf.Pow(Mathf.Pow ((Player_script.player_temp.z - Player_script.move_speed * Mathf.Cos (temp)) - Player_script.point[1], 2) , 0.5f);
							}
